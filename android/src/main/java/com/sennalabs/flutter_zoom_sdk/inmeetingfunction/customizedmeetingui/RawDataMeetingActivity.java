...
import com.sennalabs.flutter_zoom_sdk.inmeetingfunction.customizedmeetingui.rawdata.AudioRawDataUtil;
import com.sennalabs.flutter_zoom_sdk.inmeetingfunction.customizedmeetingui.rawdata.RawDataRender;
import com.sennalabs.flutter_zoom_sdk.inmeetingfunction.customizedmeetingui.rawdata.UserVideoAdapter;
...
//                changeResolution();
        ...
        } else if (id == R.id.btn_switch_share) {
            if (currentShareUserId > 0) {
                switchToShare.setVisibility(View.GONE);
        ...
        } else if (id == R.id.btn_switch_source) {
