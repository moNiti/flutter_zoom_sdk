...
import com.sennalabs.flutter_zoom_sdk.inmeetingfunction.customizedmeetingui.SimpleInMeetingBOControllerListener;
...
import com.sennalabs.flutter_zoom_sdk.inmeetingfunction.customizedmeetingui.bo.BOEventCallback;
import com.sennalabs.flutter_zoom_sdk.inmeetingfunction.customizedmeetingui.other.MeetingCommonCallback;
import com.sennalabs.flutter_zoom_sdk.inmeetingfunction.customizedmeetingui.remotecontrol.MeetingRemoteControlHelper;
import com.sennalabs.flutter_zoom_sdk.inmeetingfunction.customizedmeetingui.share.MeetingShareCallback;
import com.sennalabs.flutter_zoom_sdk.inmeetingfunction.customizedmeetingui.share.MeetingShareHelper;
import com.sennalabs.flutter_zoom_sdk.inmeetingfunction.customizedmeetingui.user.MeetingUserCallback;
import com.sennalabs.flutter_zoom_sdk.inmeetingfunction.customizedmeetingui.video.MeetingVideoCallback;
import com.sennalabs.flutter_zoom_sdk.inmeetingfunction.customizedmeetingui.video.MeetingVideoHelper;
...
import com.sennalabs.flutter_zoom_sdk.inmeetingfunction.customizedmeetingui.view.RealNameAuthDialog;
import com.sennalabs.flutter_zoom_sdk.inmeetingfunction.customizedmeetingui.view.adapter.AttenderVideoAdapter;
import com.sennalabs.flutter_zoom_sdk.inmeetingfunction.customizedmeetingui.view.share.AnnotateToolbar;
import com.sennalabs.flutter_zoom_sdk.inmeetingfunction.customizedmeetingui.view.share.CustomShareView;
import com.sennalabs.flutter_zoom_sdk.inmeetingfunction.livetranscription.LiveTranscriptionRequestHandleDialog;
import com.sennalabs.flutter_zoom_sdk.ui.BreakoutRoomsAdminActivity;
import com.sennalabs.flutter_zoom_sdk.ui.UIUtil;
...
public class MyMeetingActivity extends FragmentActivity implements View.OnClickListener, MeetingVideoCallback.VideoEvent,
    ...
    private final static String TAG = com.sennalabs.flutter_zoom_sdk.MyMeetingActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gestureDetector = new GestureDetector(new com.sennalabs.flutter_zoom_sdk.MyMeetingActivity.GestureDetectorListener());
    ...
    MeetingAudioHelper.AudioCallBack audioCallBack = new MeetingAudioHelper.AudioCallBack() {
        ...
        public boolean requestAudioPermission() {
            if (Build.VERSION.SDK_INT >= 23 && checkSelfPermission(Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(com.sennalabs.flutter_zoom_sdk.MyMeetingActivity.this, new String[]{Manifest.permission.RECORD_AUDIO}, REQUEST_AUDIO_CODE);
                return false;
            }
            return true;
        }
    ...
    MeetingShareHelper.MeetingShareUICallBack shareCallBack = new MeetingShareHelper.MeetingShareUICallBack() {
        ...
        public boolean requestStoragePermission() {
            if (Build.VERSION.SDK_INT >= 23 && checkSelfPermission(Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(com.sennalabs.flutter_zoom_sdk.MyMeetingActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, REQUEST_STORAGE_CODE);
                return false;
            }
            return true;
        }
    ...
    MeetingOptionBar.MeetingOptionBarCallBack callBack = new MeetingOptionBar.MeetingOptionBarCallBack() {
        ...
        public void onClickChats() {
            mInMeetingService.showZoomChatUI(com.sennalabs.flutter_zoom_sdk.MyMeetingActivity.this, REQUEST_CHAT_CODE);
        }

        @Override
        public void onClickPlist() {
            mInMeetingService.showZoomParticipantsUI(com.sennalabs.flutter_zoom_sdk.MyMeetingActivity.this, REQUEST_PLIST);
        }
        ...
        public void onClickAdminBo() {
            Intent intent = new Intent(com.sennalabs.flutter_zoom_sdk.MyMeetingActivity.this, BreakoutRoomsAdminActivity.class);
        ...
        public void onClickLowerAllHands() {
            if (mInMeetingService.lowerAllHands() == SDKERR_SUCCESS)
                Toast.makeText(com.sennalabs.flutter_zoom_sdk.MyMeetingActivity.this, "Lower all hands successfully", Toast.LENGTH_SHORT).show();
        }

        @Override
        public void onClickReclaimHost() {
            if (mInMeetingService.reclaimHost() == SDKERR_SUCCESS)
                Toast.makeText(com.sennalabs.flutter_zoom_sdk.MyMeetingActivity.this, "Reclaim host successfully", Toast.LENGTH_SHORT).show();
        }
...
//        meetingOptionBar.updateShareButton();
    ...
    public void onJoinWebinarNeedUserNameAndEmail(InMeetingEventHandler inMeetingEventHandler) {
        ...
        if(displayName != null && email != null) {
            ...
            MobileRTCSDKError result = ZoomSDK.getInstance().getInMeetingService().changeName(displayName, myUserId);
    ...
    public void onHelpRequestReceived(final String strUserID) {
        ...
        if (iboAdmin != null) {
            ...
            if (boAndUser == null || boAndUser.length != 2)
                return;
            new AlertDialog.Builder(com.sennalabs.flutter_zoom_sdk.MyMeetingActivity.this)
        ...
        mInMeetingServiceListener = new SimpleInMeetingListener() {
            ...
            public void onRecordingStatus(RecordingStatus status) {
                if (status == RecordingStatus.Recording_Start) {
                    LegalNoticeDialogUtil.showChatLegalNoticeDialog(com.sennalabs.flutter_zoom_sdk.MyMeetingActivity.this);
                }
            }
    ...
    private SimpleInMeetingBOControllerListener mBOControllerListener = new SimpleInMeetingBOControllerListener() {
        ...
        public void onHasAdminRightsNotification(IBOAdmin iboAdmin) {
            ...
            BOEventCallback.getInstance().addEvent(com.sennalabs.flutter_zoom_sdk.MyMeetingActivity.this);
        }
    };
    ...
    private InMeetingLiveTranscriptionController.InMeetingLiveTranscriptionListener mLiveTranscriptionListener = new InMeetingLiveTranscriptionController.InMeetingLiveTranscriptionListener() {
        ...
        @Override
        public void onLiveTranscriptionMsgReceived(String msg, InMeetingLiveTranscriptionController.MobileRTCLiveTranscriptionOperationType type) {
        ...
        public void onRequestForLiveTranscriptReceived(long requesterUserId, boolean bAnonymous) {
            ...
            LiveTranscriptionRequestHandleDialog.show(com.sennalabs.flutter_zoom_sdk.MyMeetingActivity.this, userName);
        }
